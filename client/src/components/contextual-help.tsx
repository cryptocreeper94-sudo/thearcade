    ...
    entries: [
      {
        ...
        content: "Signal (SIG) is the native asset of the Trust Layer ‚Ä‚Äù like ETH is to Ethereum. When you send Signal, you're transmitting verified intent from one participant to another, recorded permanently. Total supply: 1 billion SIG, fixed forever."
      },
      {
    ...
    entries: [
      {
        ...
        content: "Chronicles is a life simulation game set across three eras ‚Ä‚Äù Modern, Medieval, and Wild West. Your choices shape your character's story, reputation, and legacy. Powered by AI for personalized experiences.",
    ...
    entries: [
      {
        ...
        content: "Learn programming from the ground up through 8 course tracks ‚Ä‚Äù from Programming Foundations to AI-Powered 3D Creation. Built around Lume, the world's first AI-native programming language.",
      ...
      },
      {
        ...
        content: "Lume is an AI-native language where 'ask', 'think', and 'generate' are native keywords. It even accepts natural English as valid source code ‚Ä‚Äù you can literally speak your code into existence."
      }
    ]
  },
  {
    ...
    entries: [
      {
        ...
        content: "TrustHome is a professional platform for real estate agents. Manage verified agent profiles, property listings, client relationships, and build trust scores ‚Ä‚Äù all backed by blockchain verification.",
...
const contextMappings: ContextMapping[] = [
  {
    ...
    quickTips: [
      "New here? Start by creating an account ‚Ä‚Äù it takes less than a minute.",
  ...
  },
  {
    ...
    quickTips: [
      ...
      "Signal has a fixed supply of 1 billion ‚Ä‚Äù no additional minting ever."
    ]
  },
  {
  ...
  },
  {
    ...
    quickTips: [
      "Review swap rates before confirming ‚Ä‚Äù prices update in real time.",
  ...
  },
  {
    ...
    quickTips: [
      ...
      "Look for the Guardian badge ‚Ä‚Äù it means the project passed a full security audit."
    ]
  },
  {
  ...
  },
  {
    ...
    quickTips: [
      ...
      "Authors earn 70% royalties on every sale ‚Ä‚Äù the highest in publishing."
    ]
  },
  {
    routes: ["/academy"],
  ...
  },
  {
    ...
    quickTips: [
      "TrustHome is built for real estate professionals ‚Ä‚Äù agents, brokers, and teams.",
