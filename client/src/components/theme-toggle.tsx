...
/** Floating theme toggle â€â€ renders as a small pill in the bottom-left corner.
...
export function FloatingThemeToggle() {
  ...
  const icons: Record<Theme, string> = { dark: "ğŸŒ™", light: "â˜€ï¸", system: "ğŸâ€“¥ï¸" };
  ...
  return (
    <button
      ...
      title={`Theme: ${theme} â€â€ click to switch`}
...
/** Inline theme toggle â€â€ for embedding in navbars/headers */
