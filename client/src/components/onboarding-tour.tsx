...
const steps: Step[] = [
  ...
  },
  {
    ...
    description: "Our cloud IDE features an AI Agent Mode (Ctrl+Shift+K) that builds across your entire project autonomously. Connect GitHub, deploy to Vercel, and stamp your code on the blockchain with TrustHub â€â€ all from one workspace.",
  },
  {
